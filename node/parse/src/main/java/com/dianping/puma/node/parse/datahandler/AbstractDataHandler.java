...
public abstract class AbstractDataHandler implements DataHandler {
    ...
    public MetaFetcher getMetaFetcher() {
        return metaFetcher;
    }
    ...
    protected Object convertUnsignedValueIfNeeded(int pos, Object value, Meta meta) {
        Object newValue = value;
        if (value != null) {
            switch (meta.getRawTypeCodes().get(pos)) {
                case BinlogConstants.MYSQL_TYPE_TINY:
                    if ((value instanceof Integer) && (Integer) value < 0 && !meta.getSignedMap().get(pos)) {
                ...
                case BinlogConstants.MYSQL_TYPE_LONGLONG:
                    if ((value instanceof Long) && (Long) value < 0 && !meta.getSignedMap().get(pos)) {
